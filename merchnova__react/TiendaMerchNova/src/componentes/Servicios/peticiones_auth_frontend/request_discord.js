export const request_discord = {
    discord_url: async () => {
        const requestURL = await fetch('http://localhost:3000/api/Cliente/Url-Discord', { method: 'GET' });
    ...
    request_login_discord: async (dataDiscord) => {
        ...
        const request = await fetch(`http://localhost:3000/api/Cliente/Data-Discord`, {
            method: 'POST',
            headers: {
